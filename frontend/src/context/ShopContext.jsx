...
const ShopContextProvider = (props) => {
  ...
  const addToCart = async (itemId, size) => {
    ...
    //   if (!updated[itemId][size]) updated[itemId][size] = 1;
    //   else updated[itemId][size] += 1;
    //   return updated;
    // });
...
const getUserCart = async (token)=>{
  ...
  const value = {
    products, currency, delivery_fee, showSearch, setShowSearch, search, setSearch, cartItems, addToCart, getCartCount, updateQuantity, getCartAmount, navigate, backendUrl, setToken, token, setCartItems
  }
  return (
