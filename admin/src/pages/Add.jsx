  ...
  <label htmlFor='image1'>
    ...
    <div className='w-full'>
     ...
     <div className='w-full'>
      ...
      <textarea onChange={(e)=> setDescription(e.target.value)} value={description} className='w-full max-w-[500px] px-3 py-2' type='text' placeholder='Write descroption here' required/>
    </div>
      ...
      <div>
       ...
       <div>
        ...
        <select onChange={(e)=> setSubCategory(e.target.value)} className="w-full px-3 py-2" >
          ...
          <option value="Desiwear">Desiwear</option>
        </select>
      </div>
      <div>
